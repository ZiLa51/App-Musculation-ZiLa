...
initUI();
// Splash screen (fix iPhone doublon)
const splash = document.getElementById("splash");
const startBtn = document.getElementById("startApp");

// tant que le splash est visible → on bloque le scroll/interactions derrière
if (splash) document.body.classList.add("splash-open");
